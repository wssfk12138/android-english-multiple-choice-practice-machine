...
The earlier v1 pair remains in the repository as a rollback option and was not
overwritten:

- `/assets/backgrounds/study-wallpaper-warm-light-v1.webp`
- `/assets/backgrounds/study-wallpaper-night-indigo-v1.webp`
...
contrast. This round only generated and documented the assets; CSS integration,
APK packaging, LAN delivery, and GitHub publication are separate follow-up
actions after visual approval.
